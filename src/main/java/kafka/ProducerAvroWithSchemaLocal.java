 ...
 */
public class ProducerAvroWithSchemaLocal {
...
//        String schemaPath = "/cnpc/schema/avro/";
        ...
        InputStream inputStream = ProducerAvroWithSchemaLocal.class.getClassLoader().getResourceAsStream(dataFile);
...
//        Schema schema = getSchema(schemaId, zkServer, schemaPath);
        Schema schema = null;
        try {
            schema = new Schema.Parser().parse(new File("/home/jason/project/zxlstudy/src/main/resources/schemas/10000.json"));
        } catch (IOException e) {
            e.printStackTrace();
        }
